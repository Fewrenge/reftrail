...
func TestBatchCreateReferralEntriesHandler_Success(t *testing.T) {
	...
	tsvTemplateDraft := "LAST NAME\tFIRST NAME\tHEALTHCARD NUMBER\tCELL\tEMAIL\tREFERRING PHYSICIAN\tREFERRAL DATE\tCOMPLAINTS\tCOMPLAINTS SIDE\tCONSULT TYPE\tURGENCY\tTAG\tJUVONNO PATIENT ID\n" +
