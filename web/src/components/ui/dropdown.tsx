...
// --- Trigger & Content (Ref Required for Positioning) ---
...
function useDropdownMenuSubHoverDelay(closeDelay = 150, onOpenChange?: (open: boolean) => void) {
  ...
  return {
    handleTriggerEnter: () => { clearCloseTimeout(); onOpenChange?.(true); },
    handleTriggerLeave: () => scheduleClose(closeDelay),
    handleContentEnter: () => clearCloseTimeout(),
    handleContentLeave: () => scheduleClose(),
  };
}
